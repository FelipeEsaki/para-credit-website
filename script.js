...
btnAprovacao.addEventListener('click', () => {
    ...
    paragrafo.innerHTML = `Pronto! Sua proposta está aprovada e o crédito será depositado direto na sua conta! Viu como é fácil realizar seu sonho com a Para Credit? Nossa equipe estará a disposição e irá te auxiliar desde a formalização até o depósito!`;
})